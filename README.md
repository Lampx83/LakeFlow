...
| `LLM_BASE_URL` | URL Ollama/LLM cho Q&A và **Admission agent**. **Máy chạy LakeFlow phải kết nối được tới URL này.** Nếu lỗi "No route to host" khi chat Admission → dùng Ollama nội bộ (vd. `http://host:11434`). |
