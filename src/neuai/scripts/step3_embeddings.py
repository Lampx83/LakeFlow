# src/neuai/scripts/run_embeddings.py

from neuai.processing.embeddings.pipeline import run_embedding_pipeline
from neuai.config.paths import PROCESSED_PATH, EMBEDDINGS_PATH
