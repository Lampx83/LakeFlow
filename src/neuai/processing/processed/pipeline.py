# src/neuai/processing/processed/pipeline.py

from pathlib import Path
from typing import Dict, Any

from neuai.processing.processed.excel_pipeline import run_excel_pipeline
from neuai.processing.processed.pdf_pipeline import run_pdf_pipeline
