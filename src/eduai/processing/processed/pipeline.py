# src/eduai/processing/processed/pipeline.py

from pathlib import Path
from typing import Dict, Any

from eduai.processing.processed.excel_pipeline import run_excel_pipeline
from eduai.processing.processed.pdf_pipeline import run_pdf_pipeline
...
def run_processed_pipeline(
    ...
    force : bool
        True để xử lý lại dù đã có processed data
    """
